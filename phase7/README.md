...
7. This is the addition you would push to the top of your service queue in your `docker-compose.yml` file.
...
> *If you're interested in RabbitMQ, you can find specific setup guides online like [this one](https://dzone.com/articles/spring-cloud-sleuth-rabbitmq-zipkin-elasticsearch)*