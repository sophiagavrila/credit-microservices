...
public class AccountsController {
	...
	/**
	 * Passes Customer object as localhost:8080/myCustomerDetails. Customer obj is
	 * passed as method to both cards and loans controllers by using FeignClient to
	 * invoke other microservices and return details.
	 */
	...
	/**
	 * This method will accept the same request object as the above method. It will
	 * return both populated details for accounts and loans, but null values for
	 * cards in the case that service is down and Circuit Breaker has opened the
	 * circuit.
	 * 
	 * Throwable is helpful because the method is invoked due to an exception. (The
	 * FallBack method will not work without it).
	 */
